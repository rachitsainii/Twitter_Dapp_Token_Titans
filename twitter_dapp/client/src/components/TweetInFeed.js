...
const TweetInFeed = (props) => {
    ...
    async function loadAllTweets(){
      ...
      if(loadingState === 'loaded' && !tweets.length) return (
        <h1 className="loading"> No Tweets available</h1>
      )
            ...
            tweets.map((tweet, i)=>(
                ...
                <div className="completeTweet">
                    ...
                    <div className="interactions">
                        ...
                        { onlyUser ? <div className="interactionsNum"> <Bin fontSize={20} color="#ff0000" onClick={()=>deleteTweet(tweet.id)}/> </div> : <div className="interactionNums"><Matic fontSize={20}/></div>}
                    </div>
                </div>
            </div>
            ))
